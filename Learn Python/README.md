# Learn Python (7 Hours) – Complete Practice Notebook
## About This Project
This project is a **Python learning notebook** created while following a **7-hour Python tutorial**. It contains simple examples, practice questions, and explanations of Python concepts from beginner to intermediate level.
# Topics Covered
The notebook covers the following topics step by step.
## 1. Basic Arithmetic Operations
Learn how to perform simple calculations in Python.
Topics include:
* Addition
* Subtraction
* Multiplication
...
## 3. Data Types
Understand different kinds of data in Python.
Examples:
* Integer (`int`)
* Float (`float`)
* String (`str`)
...
* String to Integer
## 5. User Input
Learn how to take input from the user using the `input()` function.
Examples include:
* Taking name input
* Taking age input
* Taking number input
## 6. Print Formatting
Learn different ways to display output neatly.
Topics include:
* Normal print
* f-strings
* Formatting values
...
* List methods
## 12. Loops
Learn how to repeat tasks automatically.
Topics include:
* For loop
* Break statement
* Continue statement
Practice examples are also included.
## 13. Functions
...
## 18. Map Function
Learn how to apply a function to multiple values using `map()`.
## 19. Exception Handling
Learn how to handle errors without crashing the program.
Topics include:
* try
* except
* finally
...
Learn different ways to join strings together.
## 21. NumPy Basics
...
* Array slicing
* Filtering elements
* Selecting elements using positions
# What You Will Learn
...
4. Open `Learn_Python(7hrsvideo).ipynb`.
